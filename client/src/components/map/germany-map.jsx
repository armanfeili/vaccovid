...
import { getGermanyStatesData, clearProvincesData  } from '../../actions/covid_countries';
import { Link } from 'react-router-dom';
import { Helmet } from "react-helmet";

import { provinceData } from "./provinceData";

export class GermanyMapComponent extends Component {
    constructor() {
        super();
    ...
    async onGetAllStatesData() {
        await this.props.getGermanyStatesData();
    };
...
export default connect(
    mapStateToProps,
    { getGermanyStatesData, clearProvincesData  }
)(GermanyMapComponent);