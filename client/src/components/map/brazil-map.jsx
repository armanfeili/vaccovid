...
import { getBrazilStatesData, clearProvincesData  } from '../../actions/covid_countries';
import { Link } from 'react-router-dom';
import { Helmet } from "react-helmet";

import { provinceData } from "./provinceData";

export class BrazilMapComponent extends Component {
    constructor() {
        super();
    ...
    async onGetAllStatesData() {
        await this.props.getBrazilStatesData();
    };
    ...
    onRegionTipShow(event, label, code) {
        const province = this.searchStateCode(code.toUpperCase(), this.props.provinces);
        if (province !== undefined) {
            label.html(
                `
                <div class="map-info">
                    <img src='${require(`./../../views/all-province-flags/br-${code.toLowerCase()}.svg`) ?
                    require(`./../../views/all-province-flags/br-${code.toLowerCase()}.svg`) :
                    require(`./../../views/all-province-flags/br-br.svg`)}' 
        ...
        return (
            ...
            <div className="map-page">
                <Helmet>
                    ...
                    <title>Brazil Coronavirus map - vaccovid.live</title>
                    <meta name="description" content="Brazil Coronavirus map. New cases, New deaths, confirmed cases, total deaths, critical and active cases of all states in map." />
...
export default connect(
    mapStateToProps,
    { getBrazilStatesData , clearProvincesData }
)(BrazilMapComponent);