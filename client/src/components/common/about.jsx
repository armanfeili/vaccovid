                ...
                <div className="about">
                    <div className="about-whoweare">
                        <header className="about-whoweare-first-part">
                            ...
                            <p className="about-whoweare-first-part-description"><span className="about-advantages-paragraph-text-bold">VACCOVID.LIVE</span> now serves as an archived snapshot of vaccine, COVID-19, and treatment data collected during the pandemic. Live updates have stopped; the data shown reflects the final collection from early 2023. The site preserves historical statistics, explainer text, and news so people can review how the pandemic evolved.</p>
                        </header>
                    ...
                    <main className="about-advantages">
                        ...
                        <div className="about-advantages-paragraph">
                            <h3 className="about-advantages-paragraph-heading">Covid-19 Tracker: </h3><p className="about-advantages-paragraph-text">During the pandemic we aggregated COVID-19 data from several APIs and captured country/state level snapshots for 219 countries. Updates stopped in early 2023, so the site now preserves that historical dataset instead of pulling fresh numbers. <span className="about-advantages-paragraph-text-bold">United States of America, Canada, India, Australia, Brazil, Japan, Germany, France, United Kingdom, Netherlands, Italy, China, Chile, Colombia, Denmark, Mexico, Peru, Pakistan, Russia, Spain, Sweden, and Ukraine</span> all include state/province level detail. (Special thanks to <a onClick={this.changeOffset} href="https://covid-19-apis.postman.com/" className="about-advantages-paragraph-text-external-link">Postman</a> for providing the original API sources.)</p>
                        </div>
                        <div className="about-advantages-paragraph">
                        ...
                        <div className="about-advantages-paragraph">
                            <h3 className="about-advantages-paragraph-heading">Vaccine Tracker: </h3><p className="about-advantages-paragraph-text">Thanks to <a onClick={this.changeOffset} href="https://milkeninstitute.org/centers/fastercures" className="about-advantages-paragraph-text-external-link">FasterCures</a> (Milken institute) we captured data on more than 230 developing <Link onClick={this.changeOffset} to="/vaccine-tracker" className="about-advantages-paragraph-text-internal-link">vaccines</Link>. The information shown reflects the final archived snapshot rather than live feeds and includes:</p>
                        ...
                        <div className="about-advantages-paragraph">
                            <p className="about-advantages-paragraph-text">Vaccines are organized according to clinical stage and production platform. Details remain as they were when collection stopped, giving a historical view of the pipeline.</p>
                        </div>
                        <div className="about-advantages-paragraph">
                            <h3 className="about-advantages-paragraph-heading">Treatment Tracker: </h3><p className="about-advantages-paragraph-text">The treatment tracker is also based on the archived FasterCures dataset and organized by clinical stage and development platform.</p>
                        </div>
                        <div className="about-advantages-paragraph">
                            <p className="about-advantages-paragraph-text">Links to key medications are preserved for historical reference; no new clinical data is ingested.</p>
                        </div>
                        <div className="about-advantages-paragraph">
