...
export class Vaccine extends Component {
    ...
    render() {
        ...
        const archiveNotice = `Archived vaccine and treatment data. Last collected on ${ARCHIVE_DATE}. No live updates.`;
        ...
        return <div>
            <Helmet>
                <title>Archived coronavirus {category} vaccine tracker - vaccovid</title>
                <meta name="description" content={`Archived vaccine tracker data for ${category}. Snapshot as of February 2023 with no live updates.`} />
            </Helmet>
            {
                category ? (
                    <div>
