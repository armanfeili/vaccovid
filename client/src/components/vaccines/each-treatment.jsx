                                ...
                                eachVacItem[0] !== undefined ?
                                    <section className="each-vaccine-titleAndPic">
                                        <div className="each-vaccine-titleAndPic-titleAndCategory">
                                            <div className="each-vaccine-titleAndPic-titleAndCategory-title">{(!eachVacItem[0].description || eachVacItem[0].description === "undefined") ? (eachVacItem[0].developerResearcher || '').toUpperCase() : (eachVacItem[0].description || '').toUpperCase()}</div>
                                            <div className="each-vaccine-titleAndPic-titleAndCategory-category">{eachVacItem[0].category || 'N/A'}</div>
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-treatmentVsVaccine`}>Type: <span className="each-vaccine-titleAndPic-titleAndCategory-treatmentVsVaccine-text">{eachVacItem[0].treatmentVsVaccine || 'Treatment'}</span></div>
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-phase ${!eachVacItem[0].phase || eachVacItem[0].phase === "undefined" ? "displayOff" : ""}`}>Stage: <span className="each-vaccine-titleAndPic-titleAndCategory-phase-text">{eachVacItem[0].phase}</span></div>
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-funder ${!eachVacItem[0].funder || eachVacItem[0].funder === "undefined" ? "displayOff" : ""}`}>Funder: <span className="each-vaccine-titleAndPic-titleAndCategory-funder-text">{eachVacItem[0].funder}</span></div>
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-FDAApproved ${!eachVacItem[0].FDAApproved || eachVacItem[0].FDAApproved === "undefined" ? "displayOff" : ""}`}>FDA Approval: <span className="each-vaccine-titleAndPic-titleAndCategory-FDAApproved-text">{eachVacItem[0].FDAApproved}</span></div>
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-lastUpdated ${!eachVacItem[0].lastUpdated || eachVacItem[0].lastUpdated === "undefined" ? "displayOff" : ""}`}>Last Update: <span className="each-vaccine-titleAndPic-titleAndCategory-lastUpdated-text">{formatDate(eachVacItem[0].lastUpdated)}</span></div>
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-publishedResults ${!Array.isArray(eachVacItem[0].publishedResults) || eachVacItem[0].publishedResults.length === 0 || eachVacItem[0].publishedResults[0] === "undefined" ? "displayOff" : ""}`}>Published Results: <span className="each-vaccine-titleAndPic-titleAndCategory-publishedResults-text">{Array.isArray(eachVacItem[0].publishedResults) && eachVacItem[0].publishedResults.length > 0 && eachVacItem[0].publishedResults[0] !== "undefined" ? eachVacItem[0].publishedResults.map((e, i) => {
                                                return <a key={i} className="each-vaccine-titleAndPic-titleAndCategory-publishedResults-text-link" href={`${e}`} rel="noopener noreferrer" target="_blank">Link-{i + 1}</a>
                                            }) : 'N/A'}</span></div>
                                        </div>
                                        <div className="each-vaccine-titleAndPic-categoryPic">
                                            <img className="each-vaccine-titleAndPic-categoryPic-pic" src={`${require(`./../../views/vaccine-categories-pics/${!eachVacItem[0].trimedCategory || eachVacItem[0].trimedCategory === "other" ? "other" : eachVacItem[0].trimedCategory}.jpg`) ?
                                                require(`./../../views/vaccine-categories-pics/${!eachVacItem[0].trimedCategory || eachVacItem[0].trimedCategory === "other" ? "other" : eachVacItem[0].trimedCategory}.jpg`) :
                            ...
                            {eachVacItem[0] !== undefined ?
                                <main className="each-vaccine-desc">
                                    <div className="each-vaccine-desc-allText">
                                        <div className={`each-vaccine-desc-allText-description ${!eachVacItem[0].developerResearcher || eachVacItem[0].developerResearcher === "undefined" ? "displayOff" : ""}`}>Description: <span className="each-vaccine-desc-allText-description-text">{eachVacItem[0].developerResearcher || 'N/A'}</span></div>
                                        <div className={`each-vaccine-desc-allText-nextSteps ${!eachVacItem[0].nextSteps || eachVacItem[0].nextSteps === "undefined" ? "displayOff" : ""}`}>Next Steps: <span className="each-vaccine-desc-allText-nextSteps-text">{eachVacItem[0].nextSteps || 'N/A'}</span></div>
                                        <div className={`each-vaccine-desc-allText-clinicalTrialsForCovid19 ${!eachVacItem[0].clinicalTrialsForCovid19 || eachVacItem[0].clinicalTrialsForCovid19 === "undefined" ? "displayOff" : ""}`}>Clinical Trials For Covid-19: <span className="each-vaccine-desc-allText-clinicalTrialsForCovid19-text">{eachVacItem[0].clinicalTrialsForCovid19 || 'N/A'}</span></div>
                                        <div className={`each-vaccine-desc-allText-clinicalTrialsForOtherDiseases ${!eachVacItem[0].clinicalTrialsForOtherDiseases || eachVacItem[0].clinicalTrialsForOtherDiseases === "undefined" ? "displayOff" : ""}`}>Clinical Trials For Other Diseases: <span className="each-vaccine-desc-allText-clinicalTrialsForOtherDiseases-text">{eachVacItem[0].clinicalTrialsForOtherDiseases || 'N/A'}</span></div>
                                    </div>
                                </main>
                                : <div>...</div>}
                        </div>
