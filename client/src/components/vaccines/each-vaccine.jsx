                                ...
                                eachVacItem[0] !== undefined ?
                                    <section className="each-vaccine-titleAndPic">
                                        <div className="each-vaccine-titleAndPic-titleAndCategory">
                                            ...
                                            <div className={`each-vaccine-titleAndPic-titleAndCategory-treatmentVsVaccine`}>Type: <span className="each-vaccine-titleAndPic-titleAndCategory-treatmentVsVaccine-text">{eachVacItem[0].treatmentVsVaccine || 'Vaccine'}</span></div>
                                        ...
                                        <div className="each-vaccine-titleAndPic-categoryPic">
                                            <img className="each-vaccine-titleAndPic-categoryPic-pic" src={`${require(`./../../views/vaccine-categories-pics/${eachVacItem[0].trimedCategory || 'other'}.jpg`) ?
                                                require(`./../../views/vaccine-categories-pics/${eachVacItem[0].trimedCategory || 'other'}.jpg`) :
                            ...
                            {eachVacItem[0] !== undefined ?
                                <main className="each-vaccine-desc">
                                    <div className="each-vaccine-desc-allText">
                                        <div className={`each-vaccine-desc-allText-description ${!eachVacItem[0].description || eachVacItem[0].description === "undefined" ? "displayOff" : ""}`}>Description: <span className="each-vaccine-desc-allText-description-text">{eachVacItem[0].description || 'N/A'}</span></div>
